...
class SensorsNode : public rclcpp::Node
{
  ...
  public:
    ...
    : Node("sensors_node")
    {
      cmd_vel_sub_ = this->create_subscription<geometry_msgs::msg::Twist>("joy/cmd_vel", 10, std::bind(&SensorsNode::cmd_vel_callback, this, _1));
    ...
    void cmd_vel_callback(const geometry_msgs::msg::Twist::SharedPtr msg)
    {
      ...
      */
      ...
      if (serial_port.IsOpen()) {
        serial_port.ReadLine(str_recieved, '\n', 30);
